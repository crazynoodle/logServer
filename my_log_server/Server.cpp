...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::SetNoBlock
/// 功   能：设置该Socket为非阻塞
/// 参   数：int fd
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::SetNoBlock(int fd)
{
...
// ////////////////////////////////////////////////////////////////////////////////
// /// 名   称：LogServer::SignInfd
// /// 功   能：更新数据库客户登录信息
// /// 参   数：CSocketClient* pClient     待登录的客户Client对象指针
// /// 返回 值：bool                       private
// ////////////////////////////////////////////////////////////////////////////////
// bool LogServer::SignInfd(CSocketClient* pClient)
// {
...
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::Addfd(struct sockaddr_in* pAddr, map<int, CSocketClient*>* pMapBuffer, int epollfd, int fd)
{
...
// ////////////////////////////////////////////////////////////////////////////////
// /// 名   称：LogServer::SignOutfd
// /// 功   能：更新数据库客户登出信息
// /// 参   数：CSocketClient* pClient     待登出的客户Client对象指针
// /// 返回 值：bool                       private
// ////////////////////////////////////////////////////////////////////////////////
// bool LogServer::SignOutfd(CSocketClient* pClient)
// {
//     char strSQL[SIZE_STRSQL_MAX];
//     CTimeVal time;
//     time.getNowTime();
...
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::Delfd(map<int, CSocketClient*>* pMapBuffer, int epollfd, int fd)
{
    epoll_event event;
    memset(&event, 0x00, sizeof(event));
    event.data.fd = fd;
...
void LogServer::MyProcFunc(void* pArg)
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::EpollELWork
/// 功   能：Epoll主要工作函数
/// 参   数：stuThreadParam* pStu                      传入函数的结构体指针
///         int number                                本次捕获事件数组个数
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::EpollELWork(stuThreadParam* pStu, int number)
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::ThreadEpollWork
/// 功   能：Epoll轮询线程函数，阻塞在epoll_wait函数上
/// 参   数：void* param               类中需要传入线程中的成员变量
/// 返回 值：void*                      private
////////////////////////////////////////////////////////////////////////////////
void* LogServer::ThreadEpollWork(void* param)
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::LoadConfig
/// 功   能：读取配置文件
/// 参   数：void
/// 返回 值：bool           private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::LoadConfig()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::SetLimitMax
/// 功   能：设置文件连接最大数
/// 参   数：void
/// 返回 值：bool           private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::SetLimitMax()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::ShowSocketStatus
/// 功   能：显示机器属性
/// 参   数：void
/// 返回 值：bool           private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::ShowSocketStatus(void)
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::MaskSignal
/// 功   能：屏蔽忽略SIGPIPE信号错误
/// 参   数：void
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::ThreadPollInit()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::CreateSocket
/// 功   能：创建服务器Socket对象
/// 参   数：void
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::CreateSocket()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::CreateEpoll
/// 功   能：创建Epoll对象
/// 参   数：void
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::CreateEpoll()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::BindSocket
/// 功   能：绑定Socket
/// 参   数：void
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::BindSocket()
{
...
////////////////////////////////////////////////////////////////////////////////
/// 名   称：LogServer::ListenSocket
/// 功   能：开启服务器Socket的监听
/// 参   数：void
/// 返回 值：bool                       private
////////////////////////////////////////////////////////////////////////////////
bool LogServer::ListenSocket()
{
